...
# نکته: طبق ساختار پروژه، indicators زیر f04_features قرار دارد و engine.apply
# طبق تست‌ها به run_specs_v2 متصل است. (No guessing: بر اساس فایل‌های فعلی)
from f04_features.indicators.engine import apply as engine_apply  # entry wrapper
...
def main():
    ...
    out.to_csv("phaseC_mtf_sample.csv", index=True)
    print("Saved:", "phaseC_mtf_sample.csv")
