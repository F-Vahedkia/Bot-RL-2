...
│   │   ├── core_batch.py
│   │   ├── divergence_batch.py
│   │   ├── extras_channel_batch.py
│   │   └── extras_trend_batch.py
│   ├── **adapters_live/**
│   │   ├── core_live.py
│   │   ├── divergences_live.py
│   │   ├── extras_channel_live.py
│   │   └── extras_trend_live.py
│   ├── **engine/**
│   │   ├── adaptive_structure_engine.py
│   │   ├── adaptive_structure_wrapper.py
│   │   ├── extras_trend_engine.py
│   │   ├── extras_trend_engine_old1.py
