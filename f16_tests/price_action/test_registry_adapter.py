...
- get_price_action_registry_v2 نگاشت کامل و قابل‌فراخوانی برگرداند.
...
import pandas as pd
from f04_features.price_action import registry_adapter as pa_adap


def test_get_price_action_registry_v2_shape_and_callables_extended():
    reg = pa_adap.get_price_action_registry_v2()
...
def test_register_into_existing_registry_without_overwrite_extended():
    ...
    pa_keys = set(pa_adap.get_price_action_registry_v2().keys())
