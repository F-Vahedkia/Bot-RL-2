# f06_risk/position_sizing_contract_tester_A.py (26)
# Run from project root:
#     python -m f06_risk.position_sizing_contract_tester_A
#     pytest -v -s f06_risk/position_sizing_contract_tester_A.py
