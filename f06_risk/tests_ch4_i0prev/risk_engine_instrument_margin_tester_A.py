# f06_risk/tests_ch4_i0prev/risk_engine_instrument_margin_tester_A.py (19)
#
# Run: pytest -v -s f06_risk/tests_ch4_i0prev/risk_engine_instrument_margin_tester_A.py
