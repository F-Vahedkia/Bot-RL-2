# f06_risk/tests_ch4_i0prev/risk_projection_margin_integration_tester_A.py (18)
#
# Run:  pytest -v -s f06_risk/tests_ch4_i0prev/risk_projection_margin_integration_tester_A.py
