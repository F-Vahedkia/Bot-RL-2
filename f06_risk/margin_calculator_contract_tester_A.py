# f06_risk/margin_calculator_contract_tester_A.py (27)
...
Run from project root:
    python -m f06_risk.margin_calculator_contract_tester_A
    pytest -v -s f06_risk/margin_calculator_contract_tester_A.py
"""
