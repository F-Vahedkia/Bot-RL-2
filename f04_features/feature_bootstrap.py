...
from f04_features.indicators.registry import REGISTRY  # رجیستری اندیکاتورهای شما (تست‌شده)
from f04_features.price_action.registry_adapter import register_price_action_to_indicators_registry
...
#   from f04_features.feature_bootstrap import REGISTRY
# Example:
...
# Do NOT import this module inside f04_features/indicators/*.
